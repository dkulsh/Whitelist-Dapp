...
export default function Home() {
  ...
  const renderButton = () => {
    ...
    console.log("renderButton : walletConnected - " + walletConnected);
  ...
  useEffect(() => {
    ...
    if (! walletConnected) {
      ...
      console.log("UseEffect : Wallet not connected. Init Web3Modal ");
    ...
    console.log("UseEffect : Connecting wallet ... ");
    connectWallet();
      ...
      <div className={styles.main}>
        ...
        <div>
          ...
          <div className={styles.description}>
            Its an NFT collection for developers int Crypto
          </div>
